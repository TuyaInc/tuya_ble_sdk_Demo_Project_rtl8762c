...
#define MAX_NUMBER_OF_TUYA_MESSAGE    0x20      //!<  GAP message queue size
#define MAX_NUMBER_OF_EVENT_MESSAGE   (MAX_NUMBER_OF_GAP_MESSAGE + MAX_NUMBER_OF_IO_MESSAGE + MAX_NUMBER_OF_TUYA_MESSAGE)    //!< Event message queue size
